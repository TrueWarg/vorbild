...
optionParser =
    Option <$> templatePathParser <*> destinationParser
            ...
            strOption
               (
                   long "dst"
                    ...
                    <> showDefault 
                    <> help "Destination path of generated file. Current dir will be used if it isn't specified"
                )
...
templatePathParser =
    strOption
        (
            ...
            <> help "Input template source dir"
        )